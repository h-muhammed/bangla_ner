...
from dataloader import DataSequence, ids_exhge_labels
...
def pred_on_text(model, opt):
    ...
    text = tokenizer(sentence, padding='max_length', max_length = opt.max_token_length, truncation=True, return_tensors="pt")
