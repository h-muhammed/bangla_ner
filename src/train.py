...
def train_ner(model, df_train, df_val, opt):
    ...
    val_dataloader = DataLoader(val_dataset, num_workers=opt.num_workers, batch_size=opt.batch_size)
    ...
    else: torch.save(model, opt.checkpoints_dir + 'hisab_ner.pth')
    return model
